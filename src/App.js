  ...
  return (
    ...
    <div className="">
      ...
      <Routes>
        ...
        <Route
          path="/doctor"
          element={<Protected Component={Doctorinterface} roll={"Doctor"} />}
        />
        <Route
          path="/inventory-interface/inventory"
          element={<Protected1 Component={Inventory} roll={"Pharmacist"} />}
        />
        ...
        <Route
          path="/inventory-interface/dashboard"
          element={<Protected1 Component={Dashboard} roll={"Pharmacist"} />}
        />
        <Route
          path="/inventory-interface/manage"
          element={<Protected1 Component={Manage} roll={"Pharmacist"} />}
        />
        <Route
          path="/inventory-interface/supply"
          element={<Protected1 Component={Supply} roll={"Pharmacist"} />}
        />
        <Route path="/loginDoctor" element={<DoctorLogin />} />
        <Route path="/LoginInventory" element={<InventoryLogin />} />
        <Route
          path="/inventory-interface/settings"
          element={<Protected1 Component={Settings} roll={"Pharmacist"} />}
        />
        <Route
          path="/admin/dashboard"
          element={<Protected2 Component={DashboardAdmin} roll={"admin"} />}
        />
        <Route
          path="/admin/adddoctor"
          element={<Protected2 Component={AddDoctor} roll={"admin"} />}
        />
        <Route
          path="/admin/doctorlist"
          element={<Protected2 Component={DoctorList} roll={"admin"} />}
        />
        <Route
          path="/admin/addpatient"
          element={<Protected2 Component={AddPatient} roll={"admin"} />}
        />
        <Route
          path="/admin/editpatient"
          element={<Protected2 Component={UpdatePatient} roll={"admin"} />}
        />
        <Route
          path="/admin/patientlist"
          element={<Protected2 Component={PatientList} roll={"admin"} />}
        />
        <Route
          path="/admin/addemployee"
          element={<Protected2 Component={AddEmployee} roll={"admin"} />}
        />
        <Route
          path="/admin/employeelist"
          element={<Protected2 Component={EmployeeList} roll={"admin"} />}
        />
        <Route
          path="/admin/medicalreports"
          element={<Protected2 Component={MedicalReport} roll={"admin"} />}
        />
